...
const SignupView = () => {
  ...
  return (
    <Container maxWidth={"xs"} sx={{ mt: { xs: 2, md: 6 }, borderColor:"#292f33",borderStyle:"solid",borderRadius:5,padding:7 }} >
      <Stack alignItems="center">
        ...
        <Box component="form" onSubmit={handleSubmit}>
          ...
          <Button type="submit" halfWidth variant="contained" size="large" sx={{ my: 2,mx:17,borderRadius:8 }} >
            Sign Up
          </Button>
        </Box>
        {/* <Box sx={{ mt: 3 }}> */}
